...
private:
	...
	// ServerIO.cpp
	bool			handleClientBuffer(size_t clientIndex, const std::string &chunk);
	...
	void	operatorManager(size_t clientIndex, const std::string &modeString,
							int channelIndex, int targetFd, const std::string &targetNick);
	...
	void	keyManager(size_t clientIndex, const std::string &modeString,
					   const std::string &key, int channelIndex);
	void	maxMemberManager(size_t clientIndex, const std::string &modeString,
							 int maxNumber, int channelIndex);
